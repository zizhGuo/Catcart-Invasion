...
public class HightlightProps : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Initialise(null, highlighterOptions);
    }
    ...
    public void Initialise(Color? color = null, Dictionary<string, object> options = null)
    {
