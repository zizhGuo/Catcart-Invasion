...
public class DrillerJumpBehavior : MonoBehaviour
{
    ...
    [HideInInspector] public bool shouldComeOut = false;                    //should the driller come out of the ground or not, this variable is only manipulated by the object that spawned this
