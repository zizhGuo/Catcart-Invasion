...
public class NonPlayerPistolBulletBehavior : MonoBehaviour
{
    /// <summary>
    ...
    public GameObject playerPistolBulletWrap; // The prefab for the player side pistol bullet
    ...
    public NonPlayerDefaultEnemyBehavior[] targets; // The list contains all enemies
    ...
    public GameObject playerPistolBullet; // The player side bullet
    ...
    void Start()
    {
        ...
        targets = FindObjectsOfType<NonPlayerDefaultEnemyBehavior>(); // Include all the existing enemy in an array
        leastAngleDiff = homingRangeAngle;

        foreach (NonPlayerDefaultEnemyBehavior t in targets)
        {
        ...
        playerPistolBullet = Instantiate(playerPistolBulletWrap);
